      ...
      <div class="card-body">
       ...
       <div class="row">
           ...
           <label>First Name</label>
            <input class="form-control form-control-sm" name="firstname" type="text" required>
           </div>
           <div class="col-sm-4">
           <label>Surname</label>
            <input class="form-control form-control-sm" name="lastname" type="text" required>
           </div>
       </div>
       <br>
       ...
       <div class="row">
           <div class="col-sm-4">
           <label>DOB</label>
            <input class="form-control form-control-sm" name="dob" type="date" id="DOB" onchange="DOBAGE()"  required>
           </div>
           <div class="col-sm-4">
           <label>Age</label>
            <input class="form-control form-control-sm" name="age" type="text" id="txtAge" readonly>
           </div>
           <div class="col-sm-4">
           <label>Gender</label>
       ...
       <div class="row">
           <div class="col-sm-6">
           <label>Address</label>
            <input class="form-control form-control-sm" name="resident" type="text" required>
           </div>
           <div class="col-sm-6">
           <label>Contact</label>
            <input class="form-control form-control-sm" name="tel" type="tel" pattern="[0-9]{4}[0-9]{3}[0-9]{3}" placeholder="0123456780" maxlength="10"  required>
           </div>
       </div>
       <br>
       ...
       <div class="row">
           ...
           <label>Password</label>
            <input class="form-control form-control-sm" name="passwoord" type="password" required> 
           </div>
           <div class="col-sm-4">
           <label>Confimed Password</label>
            <input class="form-control form-control-sm" name="cpasssword" type="password" required>
           </div>
       </div>
       <br>
       ...
       <div class="row" style="text-align:center;">
           <div class="col">
           <button type="submit" name="btnregistercashier" class="btn btn-primary btn-default">Save</button>
           </div>
       </div>
          ...
          <div class="row">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody style="text-align:center; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                    ...
                    <td>
                        <form action="regit-cashier-edit.php" method="POST">
