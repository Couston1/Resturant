...
<div class="container">
    ...
    <?php
          $sql = "SELECT * FROM ad_tbl WHERE id = '$_SESSION[id]'";
                         ...
                         <form action="">
                             <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <button type="submit" name="btnSupervisonresetpassword" class="btn btn-primary  mx-auto btn-block">Reset Password</button>
                                    </div>
                                 </div>
                             </div>
                         </form>
