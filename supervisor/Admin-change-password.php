...
<form action="" method="POST">
  ...
  <div class="row">
     ...
     <button type="submit" name="Admin_btnsearch" class="btn btn-dark "><i class="fa fa-search"></i></button>
       </div>
     </div>
     </div>
     </div>
 ...
 <?php  
  if (isset($_POST['Admin_btnsearch']))
  {
                         ...
                         <form action="functions.php" method="Post">
                             <div class="row">
                                 ...
                                 <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="psw" name="passsword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required/>
                                    ...
                                    <button type="submit" name="btnresetpassword" class="btn btn-primary  mx-auto btn-block">Reset Password</button>
                                    </div>
                                 </div>
                             </div>
                         </form>
...
<?php
    ...
    {
      $_SESSION['message'] = '<h4 style="font-size:20px; text-align:center;  font-family: Gill Sans, Gill Sans MT, Calibri, Trebuchet MS, sans-serif">User Name Not found</h4>';
